...
int main() {
  ...
  window = glfwCreateWindow( windowWidth, windowHeight, "MVP Demo", NULL, NULL);
  ...
  std::shared_ptr<World> world(new World( window, windowWidth, windowHeight ));
  ...
  while (!glfwWindowShouldClose( window )) {
    ...
    world->draw( ); // false = draw normally
